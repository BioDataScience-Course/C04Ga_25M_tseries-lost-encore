...
legend("topright", legend = c("Début Semaine", "Fin Semaine"), lty = c(1,2), lwd = 2, bty = "n")#Superposition de début de semaine et fin de semaine  
...
...vos conclusions ici...
En général, on a une forte diminution au début puis une augmentation progressive qui se répète chaque année, mais pour chaque année il y a une augmentation du double par rapport à l'année précédente. Ceci pour le Travail, les Loisirs et le Transport, à exception de la Résidence ou c'est exactement l'inverse.
=======
...
>>>>>>> fc0939224006c77484052fe6c02ab44486d7d7e8
